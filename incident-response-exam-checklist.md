...
- SIEM correlation → [`kql-and-spl-query-reference-cheatsheet.md`](../01-SOC-and-SIEM-Analysis/kql-and-spl-query-reference-cheatsheet.md)
- Windows Event ID lookups → [`windows-event-id-reference-cheatsheet-professional.md`](../01-SOC-and-SIEM-Analysis/windows-event-id-reference-cheatsheet-professional.md)
