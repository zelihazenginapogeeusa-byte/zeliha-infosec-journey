...
Confirm SMB is actually running and grab the OS/domain details before diving into deeper enumeration.
...
Nmap's built-in scripts cover most of the same ground as enum4linux/rpcclient in a single scan.
...
The most common critical SMB CVEs worth checking for once version/patch info is known.
