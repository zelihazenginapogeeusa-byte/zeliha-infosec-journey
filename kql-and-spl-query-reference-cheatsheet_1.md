...
*Companion to [`siem-splunk-elk-cheatsheet-professional.md`](siem-splunk-elk-cheatsheet-professional.md) in this folder, and [`threat-intelligence-mitre-attack-cheatsheet-professional.md`](../02-DFIR-and-Threat-Intelligence/threat-intelligence-mitre-attack-cheatsheet-professional.md).*
