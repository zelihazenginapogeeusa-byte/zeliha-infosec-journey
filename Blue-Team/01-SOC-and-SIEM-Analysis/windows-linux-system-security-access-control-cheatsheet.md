...
- [ ] Confirm audit policy (Windows) or auditd rules (Linux — see [`linux-forensics-and-artifact-analysis-cheatsheet.md`](linux-forensics-and-artifact-analysis-cheatsheet.md)) actually capture the events you'd need during an investigation, before an incident forces you to find out they don't.
