...
Commands for finding an active C2 connection or a process with injected/malicious code sitting in memory.
...
Once a case is open, this is where each type of evidence lives inside Autopsy's interface.
