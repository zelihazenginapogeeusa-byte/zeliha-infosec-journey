...
*Tool mechanics: [`volatility-autopsy-forensics-cheatsheet-professional.md`](volatility-autopsy-forensics-cheatsheet-professional.md). Memory-side companion: [`memory-and-disk-forensics-quickref.md`](memory-and-disk-forensics-quickref.md). Linux-side equivalent: [`linux-forensics-and-artifact-analysis-cheatsheet.md`](linux-forensics-and-artifact-analysis-cheatsheet.md). BTL1 exam methodology: [`incident-response-exam-checklist.md`](incident-response-exam-checklist.md).*
