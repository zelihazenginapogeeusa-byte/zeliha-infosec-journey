...
| [windows-linux-system-security-access-control-cheatsheet.md](01-SOC-and-SIEM-Analysis/windows-linux-system-security-access-control-cheatsheet.md) | Access-control models — Windows DACL/ACE and Group Policy security settings, Linux permissions/sudoers/SELinux-AppArmor, service hardening checklist |
| [network-security-ids-ips-snort-cheatsheet.md](01-SOC-and-SIEM-Analysis/network-security-ids-ips-snort-cheatsheet.md) | Firewall fundamentals, IDS vs. IPS, Snort rule anatomy and example rules, tuning/false-positive management |
| [python-for-blue-team-soc-automation-cheatsheet.md](01-SOC-and-SIEM-Analysis/python-for-blue-team-soc-automation-cheatsheet.md) | Log parsing with regex, IOC extraction, VirusTotal/AbuseIPDB API queries, simple alert-correlation scripting |
...
| [active-directory-compromise-lateral-movement-playbook.md](02-DFIR-and-Threat-Intelligence/active-directory-compromise-lateral-movement-playbook.md) | Scenario playbooks for AD attacks — Kerberoasting, AS-REP Roasting, DCSync, Golden/Silver Ticket, Pass-the-Hash lateral movement |
| [blue-team-labs-online-btlo-cheatsheet.md](02-DFIR-and-Threat-Intelligence/blue-team-labs-online-btlo-cheatsheet.md) | Consolidated investigation-methodology reference across 7 solved Blue Team Labs Online challenges (Sysmon/PowerShell/phishing/network analysis/threat-report reading) — links out to full write-ups on Medium |
