...
5. **Stabilize the shell** immediately (see [`netcat-reverse-shell-cheatsheet-professional.md`](../03-Exploitation-and-Post-Exploitation/netcat-reverse-shell-cheatsheet-professional.md) §4) — an unstable shell wastes far more time than the 30 seconds stabilizing costs.
6. **Enumerate for privesc** (see [`privilege-escalation-linux-windows-cheatsheet.md`](../03-Exploitation-and-Post-Exploitation/privilege-escalation-linux-windows-cheatsheet.md)) — run the 60-second manual checklist before reaching for an automated script.
...
- [ ] Executive summary / methodology section present if the exam report template calls for one (see [`assessment-methodology-report-writing-cheatsheet-professional.md`](assessment-methodology-report-writing-cheatsheet-professional.md), in this folder).
